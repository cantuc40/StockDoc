...
having to type in everything in the main function (THIS FILE IS FOR TESTIN PURPOSES ONLY)

Issues: Difficulties in appending arrays without having to retype 'array_name.append(name of stock/crypto)' 
for every stock and/or crypto initialized
"""
